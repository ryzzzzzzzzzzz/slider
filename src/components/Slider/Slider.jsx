...
const Slider = () => {
    ...
    const slides = [
        ...
        {img: bg2, heading: 'Текст сообщения', largeBlock: (<span><b>Lorem ipsum dolor sit amet</b>, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Duis ut diam quam nulla, Mauris in aliquam sem fringilla ut morbi tincidunt.
